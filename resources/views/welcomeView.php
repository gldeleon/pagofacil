...
<html lang="en">
    ...
    <head>
        ...
        <title>prueba pago facil | API REST</title>
    ...
    <body id="page-top">
        ...
        <!--        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
                    <div class="container">
                        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img class="img-responsive" width="30%" src="http://icons.iconarchive.com/icons/elegantthemes/beautiful-flat-one-color/96/dev-icon.png"> </a>
        ...
        <header class="masthead">
            <div class="header-content">
                <div class="header-content-inner">
                    <h1 id="homeHeading">API pagofacil</h1>
                    <hr>
<!--                    <p>Start Bootstrap can help you build better websites using the Bootstrap CSS framework! Just download your template and start going, no strings attached!</p>-->
                    <!--                    <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">ir a documentación</a>-->
                </div>
            </div>
        </header>
